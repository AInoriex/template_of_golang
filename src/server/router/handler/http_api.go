...
func Recovery() func(*gin.Context) {
	return gin.CustomRecovery(func(c *gin.Context, err interface{}) {
		...
		Alarm2LarkLocal(alarm.LarkServerAlarmTextVariable{
			Level: alarm.AlarmLevelPanic,
			Title: "handler.http_api Recovery Panic",
			Msg:   "MagicServer Live服务发生PANIC告警:\n" + string(jsons),
		})
